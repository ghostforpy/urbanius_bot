    ...
    conv_handler = ConversationHandler( 
        ...
        states={
            ...
            "working_about_info":[                    
                    ...
                    MessageHandler(Filters.text([ABOUT_MENU["social_nets"]]) & FilterPrivateNoCommand, manage_social_nets),
                    MessageHandler(Filters.text([ABOUT_MENU["tags"]]) & FilterPrivateNoCommand, manage_tags),
                    MessageHandler(Filters.text([BACK_PROF["back"]]) & FilterPrivateNoCommand, go_start_conversation),
                    ],
